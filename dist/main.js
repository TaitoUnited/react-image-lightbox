            ...
            var ReactImageLightbox = function(_Component) {
                function ReactImageLightbox(props) {
                    ...
                    return _this.state = {
                        ...
                        loadErrorStatus: {}
                    }, _this.closeIfClickInner = _this.closeIfClickInner.bind(_this), _this.handleImageMouseWheel = _this.handleImageMouseWheel.bind(_this), 
                    _this.handleKeyInput = _this.handleKeyInput.bind(_this), _this.handleMouseUp = _this.handleMouseUp.bind(_this), 
                    _this.handleMouseDown = _this.handleMouseDown.bind(_this), _this.handleMouseMove = _this.handleMouseMove.bind(_this), 
                    _this.handleOuterMousewheel = _this.handleOuterMousewheel.bind(_this), _this.handleTouchStart = _this.handleTouchStart.bind(_this), 
                    _this.handleTouchMove = _this.handleTouchMove.bind(_this), _this.handleTouchEnd = _this.handleTouchEnd.bind(_this), 
                    _this.handlePointerEvent = _this.handlePointerEvent.bind(_this), _this.handleCaptionMousewheel = _this.handleCaptionMousewheel.bind(_this), 
                    _this.handleWindowResize = _this.handleWindowResize.bind(_this), _this.handleZoomInButtonClick = _this.handleZoomInButtonClick.bind(_this), 
                    _this.handleZoomOutButtonClick = _this.handleZoomOutButtonClick.bind(_this), _this.requestClose = _this.requestClose.bind(_this), 
                    _this.requestMoveNext = _this.requestMoveNext.bind(_this), _this.requestMovePrev = _this.requestMovePrev.bind(_this), 
                    _this;
                }
                return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, null, [ {
                    ...
                    value: function(event) {
                        ...
                        if (event.stopPropagation(), !this.isAnimating()) {
                            ...
                            switch (event.which || event.keyCode) {
                              ...
                              case _constant.KEYS.UP_ARROW:
                                event.preventDefault(), this.changeZoom(this.state.zoomLevel + _constant.ZOOM_BUTTON_INCREMENT_SIZE);
                                break;

                              case _constant.KEYS.DOWN_ARROW:
                                ...
                                } else this.requestClose(event);
                                break;

                              case _constant.KEYS.ENTER:
                                event.preventDefault(), this.state.zoomLevel > _constant.MIN_ZOOM_LEVEL ? this.changeZoom(_constant.MIN_ZOOM_LEVEL) : this.changeZoom(_constant.MIN_ZOOM_LEVEL + _constant.ZOOM_BUTTON_INCREMENT_SIZE);
                            }
                        }
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        var moveDeltaX = Math.abs(this.state.offsetX - this.moveStartOffsetX), moveDeltaY = Math.abs(this.state.offsetY - this.moveStartOffsetY);
                        moveDeltaX < _constant.DRAG_ZOOM_OUT_THRESHOLD && moveDeltaY < _constant.DRAG_ZOOM_OUT_THRESHOLD && this.changeZoom(_constant.MIN_ZOOM_LEVEL), 
                    ...
                    value: function(event) {
                        ...
                        this.currentAction = _constant.ACTION_NONE, this.swipeStartX = 0, this.swipeStartY = 0, 
                        this.swipeEndX = 0, this.swipeEndY = 0;
                        var clientX = event.changedTouches ? event.changedTouches[0].clientX : event.clientX, clientY = event.changedTouches ? event.changedTouches[0].clientY : event.clientY;
                        if (xDiffAbs < _constant.MIN_SWIPE_DISTANCE) {
                            if (xDiffAbs < this.getLightboxRect().width / 4) return void this.changeZoom(this.state.zoomLevel + _constant.ZOOM_BUTTON_INCREMENT_SIZE, clientX, clientY);
                        }
                        !event || this.isAnimating() || xDiffAbs < 1.5 * yDiffAbs || (xDiff > 0 && this.props.prevSrc ? (event.preventDefault(), 
                        this.requestMovePrev()) : xDiff < 0 && this.props.nextSrc && (event.preventDefault(), 
                    ...
                    value: function() {
                        ...
                        var images = [], addImage = function(srcType, imageClass, transforms) {
                            ...
                            if (_this16.props[srcType]) {
                                ...
                                zoomLevel > _constant.MIN_ZOOM_LEVEL ? (imageStyle.cursor = "move", imageStyle.zIndex = 1) : imageStyle.cursor = "zoom-in";
 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        exports.DRAG_ZOOM_OUT_THRESHOLD = 20, exports.WHEEL_MOVE_Y_THRESHOLD = 1, exports.KEYS = {
            ENTER: 13,
            ESC: 27,
            LEFT_ARROW: 37,
            UP_ARROW: 38,
        ...
        exports.SOURCE_POINTER = 3, exports.MIN_SWIPE_DISTANCE = 100;
    }, /* 8 */
    /***/
    function(module, exports, __webpack_require__) {
